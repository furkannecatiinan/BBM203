...
{
private:
    std::string name;  // Name of the Isle
   int capacity = 10; // If more realm shapers than this capacity gathers at this isle, it self-destructs and must be deleted from the map
